      ...
      <div className="relative px-4 pt-4 pb-2">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-xs font-bold text-foreground">AI Prediction</h3>
          </div>
          <Badge variant="secondary" className="text-[8px] font-semibold bg-primary/8 text-primary/70 border-primary/10 tracking-wider uppercase">
            Claude AI
          </Badge>
        </div>
        <p className="text-[9px] text-muted-foreground/40 mt-1 tracking-wider">AAPL · 7-day forecast</p>
      </div>
